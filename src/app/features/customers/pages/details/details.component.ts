...
export class DetailsCustomerComponent {
  ...
  customerForm: FormGroup = this.fb.group({
    ...
    dni: [{ value: null }, [Validators.required, Validators.maxLength(20)]],
    phone: [{ value: null }, [Validators.required, Validators.maxLength(20)]],
    fullName: [{ value: null }, [Validators.required, Validators.maxLength(50)]],
